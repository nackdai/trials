...
// é©ï™é©êgÇ™éùÇ¡ÇƒÇ¢ÇÈì_ÇéqãüÇ…ï™ÇØÇƒÇ¢Ç≠.
void PWNode ::split(){
    // éqãüÇçÏê¨.
...
PWNode *PWNode::add(Point &point){
	...
	if(isLeafNode()){
        ...
        // NOTE
        // storeLimit ÇÕ 20000 Ç≈åàÇﬂë≈ÇøÇ≥ÇÍÇƒÇ¢ÇÈ.
        ...
        // ÉXÉyÅ[ÉVÉìÉOÉOÉäÉbÉhÇ…ìoò^.
        // ìoò^Ç≈Ç´ÇΩÇ©Ç«Ç§Ç©Ç™ï‘Ç¡ÇƒÇ≠ÇÈ.
        // ìoò^çœÇ›ÇÃì_Ç∆ÇÃãóó£Ç™àÍíËà»è„ãÛÇ¢ÇƒÇ¢ÇÈèÍçáÇ…ìoò^Ç≈Ç´ÇÈ.
...
void PotreeWriter::processStore(){
    ...
    // storeThreadÇÃèàóùÇ™èIÇÌÇÈÇÃÇë“Ç¬.
	waitUntilProcessed();
